package example.trzesniowskiszymon.mp3Player.controller;
...
import example.trzesniowskiszymon.mp3Player.mp3.Mp3Parser;
import example.trzesniowskiszymon.mp3Player.mp3.Mp3Song;
import example.trzesniowskiszymon.mp3Player.player.Mp3Player;
